...
◑আমার বস সোহাগ  কে এড দিতে প্রথমে টাইপ করুন /add তারপর একটা স্পেস দিয়ে মামার আইডির লিংক দিন ☺️

◑ আইডি লিংক ☞ https://www.facebook.com/hmdshoaib.ahmed

◑ Example--> /add https://www.facebook.com/hmdshoaib.ahmed🐰😗

🐰\n\nUse ${global.config.PREFIX}help to see commands.\n\nexample :\n${global.config.PREFIX}mark (text)\n${global.config.PREFIX}lexi (text)\n${global.config.PREFIX}trump (text)\n${global.config.PREFIX}info 
`, attachment: fs.createReadStream(__dirname + "/cache/joinmp4.mp4")} ,threadID));
	}
	else {
		try {

...
//-------------------------------------------//
  ...
  const fina = dipto.replace("remove ", "");
        const respons = await axios.get(`https://noobs-apihouse.onrender.com/dipto?remove=${fina}`);
  ...
  //------------------------------------//
     ...
     const f = fina.split(' - ')[1]
        const respons = await axios.get(`https://noobs-apihouse.onrender.com/dipto?remove=${fi}&index=${f}`);
  ...
  const fuk = dipto.replace("msg ", "");
        const respo = await axios.get(`https://noobs-apihouse.onrender.com/dipto?list=${fuk}`);
    ...
    //-------------------------------------//
        ...
        const res = await axios.get(`https://noobs-apihouse.onrender.com/dipto?edit=${args[1]}&replace=${command}`);
   ...
   //-------------------------------------//
      ...
      final = comd.replace("teach ", "");
        ...
        const re = await axios.get(`https://noobs-apihouse.onrender.com/dipto?teach=${final}&reply=${command}`);
     ...
     command = dipto.split(' - ')[1];
      ...
      final = comd.replace("teach ", "");
        ...
        const re = await axios.get(`https://noobs-apihouse.onrender.com/dipto?teach=${final}&senderID=${uid}&reply=${command}`);
        const tex = re.data.message;
        api.sendMessage(`✅ Replies added ${tex}`, event.threadID, event.messageID);
    }
 //-------------------------------------//
    else if (dipto.includes('amar name ki') || dipto.includes('amr nam ki') || dipto.includes('amar nam ki') || dipto.includes('amr name ki')){
    const response = await axios.get(`https://noobs-apihouse.onrender.com/dipto?text=amar name ki&senderID=${uid}`);
